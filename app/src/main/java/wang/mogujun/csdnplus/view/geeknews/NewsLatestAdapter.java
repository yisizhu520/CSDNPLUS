...
public class NewsLatestAdapter extends BaseRecyclerAdapter<NewsLatestListInfo> {


    @Inject
    EventBus eventBus;

    public NewsLatestAdapter(Context ctx, List<NewsLatestListInfo> list) {
        super(ctx, list);
    ...
    @Override
    public void bindData(RecyclerViewHolder holder, int position, final NewsLatestListInfo item) {
