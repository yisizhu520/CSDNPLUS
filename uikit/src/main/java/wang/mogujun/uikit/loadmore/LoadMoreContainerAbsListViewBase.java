 ...
 * @author huqiu.lhq
 */
public abstract class LoadMoreContainerAbsListViewBase extends LinearLayout implements LoadMoreContainer {
    ...
    public LoadMoreContainerAbsListViewBase(Context context) {
        super(context);
    }

    public LoadMoreContainerAbsListViewBase(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
